                        ...
                        <label class="block font-semibold">Email<label>
                                ...
                                <label class="block mt-3 font-semibold">Password<label>
                                        ...
                                        <div class="flex justify-between items-baseline">
                                            <button
                                                class="m-2 bg-emerald-500 text-white py-2 px-6 rounded-lg">Login</button>
                                            <button class="m-2 bg-orange-600 text-white py-2 px-6 rounded-lg"><a
                                                    href="{{ route('register') }}">Register user</a></button>
